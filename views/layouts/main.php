        ...
        <div class="navbar-header">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        ...
                        <?php $client = UserProfile::find()->one();?>
                    <img class="rounded-circle header-profile-user" src="<?=Yii::$app->homeUrl?>uploads/<?=$client->user_photo?>"
                         alt="Header Avatar">
               
                    <span class="d-none d-xl-inline-block ml-1"><?=$client->userInfo->fullname?></span>
                    <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-right">
                    <!-- item-->
                    <a class="dropdown-item" href="<?=\yii\helpers\Url::to(['cabinet/index','id'=>$client->user_id])?>"><i class="ri-user-line align-middle mr-1"></i> Profile</a>
